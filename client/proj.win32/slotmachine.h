...
class CC_DLL SlotmachinePlayer : public CCObject
{
public:
...
private:
    static SlotmachinePlayer *s_sharedInstance;
    static SlotmachinePlayer *sharedInstance(void);
    static void purgeSharedInstance(void);

    SlotmachinePlayer(void);
