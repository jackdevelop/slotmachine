    ...
    int       nCmdShow)
{
    ...
    return SlotmachinePlayer::createAndRun();
}

int SlotmachinePlayer::createAndRun(void)
{
    SlotmachinePlayer *host = SlotmachinePlayer::sharedInstance();
    int ret = host->run();
    SlotmachinePlayer::purgeSharedInstance();
    return ret;
}

SlotmachinePlayer *SlotmachinePlayer::s_sharedInstance = NULL;

SlotmachinePlayer *SlotmachinePlayer::sharedInstance(void)
{
    if (!s_sharedInstance)
    {
        s_sharedInstance = new SlotmachinePlayer();
    }
    return s_sharedInstance;
}

void SlotmachinePlayer::purgeSharedInstance(void)
{
    if (s_sharedInstance)
    {
...
SlotmachinePlayer::SlotmachinePlayer(void)
: m_app(NULL)
, m_hwnd(NULL)
, m_exit(TRUE)
...
int SlotmachinePlayer::run(void)
{
    ...
    do
    {
        ...
        SetWindowTextA(m_hwnd, "slotmachine-player");
...
void SlotmachinePlayer::loadProjectConfig(void)
{
    vector<string> args;
...
void SlotmachinePlayer::createViewMenu(void)
{
...
void SlotmachinePlayer::updateMenu(void)
{
    HMENU menu = GetMenu(m_hwnd);
    HMENU viewMenu = GetSubMenu(menu, 1);
...
void SlotmachinePlayer::updateWindowTitle(void)
{
}

void SlotmachinePlayer::relaunch(void)
{
...
void SlotmachinePlayer::writeDebugLog(const char *log)
{
...
// menu callback
void SlotmachinePlayer::onFileOpenProject(void)
{
...
void SlotmachinePlayer::onFileCreateProjectShortcut(void)
{
    ...
    if (SUCCEEDED(hres))
    {
        ...
        psl->SetDescription(L"SlotmachinePlayer");
...
void SlotmachinePlayer::onFileProjectConfig(void)
{
...
void SlotmachinePlayer::onFileRelaunch(void)
{
    relaunch();
}

void SlotmachinePlayer::onFileExit(void)
{
    DestroyWindow(m_hwnd);
}

void SlotmachinePlayer::onViewChangeFrameSize(int viewMenuID)
{
...
void SlotmachinePlayer::onViewChangeOrientation(int viewMenuID)
{
    bool isLandscape = m_project.isLandscapeFrame();
...
void SlotmachinePlayer::onViewChangeZoom(int scaleMode)
{
    float scale = 1.0f;
...
void SlotmachinePlayer::onHelpAbout(void)
{
    DialogBox(GetModuleHandle(NULL), MAKEINTRESOURCE(IDD_ABOUTBOX), m_hwnd, AboutDialogCallback);
}

// windows callback
LRESULT SlotmachinePlayer::WindowProc(UINT message, WPARAM wParam, LPARAM lParam, BOOL* pProcessed)
{
    int wmId, wmEvent;
    SlotmachinePlayer *host = SlotmachinePlayer::sharedInstance();
...
INT_PTR CALLBACK SlotmachinePlayer::AboutDialogCallback(HWND hDlg, UINT message, WPARAM wParam, LPARAM lParam)
{
